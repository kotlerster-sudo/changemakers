...
def get_dashboard_overview(filters=None):
    ...
    # 1. Structure — all counts come directly from Street List so they
    # respect scope filters without any cross-table string matching.
    struct = frappe.db.sql(f"""
        SELECT
            ...
            COUNT(DISTINCT sl.ac_alloted)         AS acs
